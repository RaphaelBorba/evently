  ...
  return (
    <>
      <section className='bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10'>
        <div className='wrapper grid grid-cols-1 gap-5 text-center md:grid-cols-2 md:text-start 2xl:gap-0'>
      ...
      <section id='events' className='wrapper my-9 flex flex-col gap-8 md:gap-12'>
