                ...
                {orders &&
                  orders.map((row: IOrderItem) => {
                    ...
                    <tr
                      ...
                      <td className="min-w-[200px] flex-1 py-4 pr-4">{row.buyerEmail}</td>
...
{/*           <tfoot>
            <tr className="p-regular-14 lg:p-regular-16 border-b ">
                <td className="min-w-[200px] flex-1 py-4 pr-4">Orders: {orders?.length}</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td className='min-w-[200px] flex-1 py-4 text-right'>Total: {formatPrice(`${total}`)}</td>
            </tr>
          </tfoot> */}
        </table>
      </section>
